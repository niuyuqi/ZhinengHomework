...
import com.example.Homework.fragment.TabFirstFragment;
import com.example.Homework.fragment.TabSecondFragment;
import com.example.Homework.fragment.TabThirdFragment;
...
public class TabFragmentActivity extends AppCompatActivity {
    ...
    private String[] hintArray = {"商品", "商品", "商品", "商品"};
    ...
    private void initSearchView(Menu menu) {
        ...
        // 创建搜索结果页面的组件名称对象
        ComponentName cn = new ComponentName(this, com.example.Homework.SearchResultActvity.class);
