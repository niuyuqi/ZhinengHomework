...
import com.example.Homework.bean.UserInfo;
import com.example.Homework.database.UserDBHelper;
import com.example.Homework.util.DateUtil;
import com.example.Homework.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private String[] typeArray = {"个人用户", "用户","18990267牛雨琪"};
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_forget) {
            ...
            if (rb_password.isChecked()) {
                Intent intent = new Intent(this, com.example.Homework.LoginForgetActivity.class);
            ...
            if (rb_password.isChecked()) {
                Intent intent = new Intent(this, com.example.Homework.SQLiteWriteActivity.class);
                startActivityForResult(intent, mRequestCode);
            }
        }
    }
