...
import com.example.Homework.bean.CartInfo;
import com.example.Homework.bean.GoodsInfo2;
import com.example.Homework.database.CartDBHelper;
import com.example.Homework.database.GoodsDBHelper;
import com.example.Homework.util.SharedUtil;
...
public class ShoppingCartActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_shopping_channel) { // 点击了“商场”按钮
            // 跳转到手机商场页面
            Intent intent = new Intent(this, com.example.Homework.MainActivity.class);
    ...
    private void goDetail(long rowid) {
        Intent intent = new Intent(this, com.example.Homework.ShoppingDetailActivity.class);
    ...
    private void showCart() {
        ...
        for (int i = 0; i < mCartArray.size(); i++) {
            ...
            iv_thumb.setImageBitmap(com.example.Homework.MainApplication.getInstance().mIconMap.get(info.goods_id));
