...
import com.example.homework005.adapter.PlanetGridAdapter;
import com.example.homework005.bean.Planet;
...
public class GridViewActivity extends AppCompatActivity {
    ...
    private String[] dividerArray = {
            ...
            "内部分隔线(NO_STRETCH)",
            "内部分隔线(COLUMN_WIDTH)",
            "内部分隔线(STRETCH_SPACING)",
            "内部分隔线(SPACING_UNIFORM)",
