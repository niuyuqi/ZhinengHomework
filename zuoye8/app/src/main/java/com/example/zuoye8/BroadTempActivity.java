...
import com.example.homework005.adapter.BroadcastPagerAdapter;
import com.example.homework005.bean.GoodsInfo;
import com.example.homework005.fragment.BroadcastFragment;

public class BroadTempActivity extends AppCompatActivity {
    private static final String TAG = "BroadTempActivity";
    private ConstraintLayout cl_brd_temp;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fragment_dynamic);
        cl_brd_temp = findViewById(R.id.cl_brd_temp);
    ...
    private class BgChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null) {
                ...
                // 把页面背景设置为广播发来的颜色
                cl_brd_temp.setBackgroundColor(color);
            }
        }
    }
}